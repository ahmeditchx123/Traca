...
import { RunSheetComponent } from 'app/entities/run-sheet/run-sheet.component';
...
describe('Component Tests', () => {
    describe('RunSheet Management Component', () => {
        let comp: RunSheetComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(RunSheetComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.runSheets[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
