...
import { TransitionHistoryComponent } from 'app/entities/transition-history/transition-history.component';
...
describe('Component Tests', () => {
    describe('TransitionHistory Management Component', () => {
        let comp: TransitionHistoryComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TransitionHistoryComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new TransitionHistory(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.transitionHistories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
