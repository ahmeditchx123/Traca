...
describe('Service Tests', () => {
    describe('Shipper Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ShipperService);
            httpMock = injector.get(HttpTestingController);

            elemDefault = new Shipper(0, 0, 0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should update a Shipper', async () => {
                const returnedFromService = Object.assign(
                    {
                        firstPhone: 1,
                        secondPhone: 1
            ...
            it('should return a list of Shipper', async () => {
                const returnedFromService = Object.assign(
                    {
                        firstPhone: 1,
                        secondPhone: 1
